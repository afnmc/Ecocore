 ...
 * updates stock via {@code StockManager}, and records a price history
 * snapshot. This is the single entry point GUIs and commands should call —
 * neither should touch {@code PricingEngine} or {@code StockManager} directly.
 */
