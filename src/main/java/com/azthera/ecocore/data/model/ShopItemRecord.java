 ...
 *
 * <p>Since V3 migration, this record also tracks {@code sellPrice} separately
 * from {@code currentPrice} (which is the buy price). The sell price is
 * typically 70% of the buy price (30% spread), but can be configured
 * independently per item in {@code shop-items.yml}.</p>
 */
public final class ShopItemRecord {
    ...
    public ShopItemRecord(String itemId, double basePrice, double currentPrice, double sellPrice,
                           double minPrice, double maxPrice, double elasticity, double demand, double supply,
                           long restockIntervalSeconds, int stock, long lastRestockMillis) {
        this.itemId = itemId;
